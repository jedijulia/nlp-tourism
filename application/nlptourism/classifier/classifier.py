...
# extracts features using the bag-of-words method
...
# extracts features using the top words method
...
# extracts features using the top words with weights method
...
# extracts features using the top words with weights method using words from TripAdvisor
...
# extracts features using the top words with weights method using words generated by LDA from TripAdvisor
...
# process data from files and db (generated by manual verification and validation in the web app)
...
# perform 10-fold cross validation given a classifier, training set and test set
...
def train_db(tourism_tweets, nontourism_tweets):
    ...
    # plot learning curves and save to a specified file path
